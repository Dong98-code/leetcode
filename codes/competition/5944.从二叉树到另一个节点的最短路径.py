# -*- coding: utf-8 -*-
# @Time : 2021/12/5 13:20
# @Author : XDD
# @File : 5944.从二叉树到另一个节点的最短路径.py
from codes.utils.BinaryTree import *
from codes.utils.draw_tree import *

root = creat_tree([1,None,10,12,13,4,6,None,15,None,None,5,11,None,2,14,7,None,8,None,None,None,9,3])
...
sol = Solution()
print(sol.getDirections(root, startValue=6, destValue=15))
